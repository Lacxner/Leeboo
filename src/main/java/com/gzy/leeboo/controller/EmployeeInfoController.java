...
public class EmployeeInfoController {
    ...
    public Result getAllEmployees(@PathVariable("currentPage") Integer currentPage, @PathVariable("pageSize") Integer pageSize) {
    ...
    public Result searchEmployees(@RequestBody SearchEmployee searchEmployee, @PathVariable("currentPage") Integer currentPage, @PathVariable("pageSize") Integer pageSize) {
        // 格式化工号
    ...
    public Result deleteBatchEmployeeByIds(@RequestBody List<Integer> ids) {
